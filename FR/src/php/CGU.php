...
<div class="cgu-container">
    ...
    <div class="section">
        ...
        <p>Certains services nécessitent la création d’un compte utilisateur...</p>
    </div>
    <div class="section">
    ...
    <div class="section">
        ...
        <p>Les données collectées sont nécessaires à la gestion des comptes et des commandes...</p>
    </div>
    <div class="section">
        <h2>7. Cookies</h2>
        <p>Le Service utilise des cookies pour améliorer l’expérience utilisateur...</p>
    </div>
    <div class="section">
    ...
    <div class="section">
        ...
        <p>Les présentes CGU sont applicables pendant toute la durée d’accès au Service...</p>
    </div>
    <div class="section">
    ...
    <div class="section">
        <h2>12. Contact</h2>
        <p>Pour toute question concernant ces CGU, consultez notre <a href="faq.php" target="_blank">FAQ</a>.</p>
    </div>
